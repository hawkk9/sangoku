...
RSpec.describe Battle::Battling::Skills::SikabaneHiroi, type: :model do
  describe '屍拾い' do
    ...
    let!(:sikabane_hiroi) { Battle::Battling::Skills::SikabaneHiroi.new(battling_user, battling_opponent_user) }
