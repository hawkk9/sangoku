...
RSpec.describe Skills::AgitationSkill, type: :model do
  describe '#keiryaku_before_battle_effect' do
    ...
    context '攻撃側' do
      it 'ターン数が10増加すること' do
        Skills::AgitationSkill::keiryaku_before_battle_effect(user, opponent_user, battle_context, true)
        expect(battle_context.turn_limit).to eq 47
      end
    end
    context '守備側' do
      it 'ターン数が10減少すること' do
        Skills::AgitationSkill::keiryaku_before_battle_effect(user, opponent_user, battle_context, false)
